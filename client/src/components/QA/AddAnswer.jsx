  ...
  render() {
    return (
      <form
        ...
        style={{
          visibility:
            Number(this.props.addAnswerTo) === Number(this.props.questionId)
              ? "visible"
              : "hidden",
        }}
      >
        ...
        <span className="closeForm" onClick={this.props.onClick}>
          x
        </span>
        ...
        >
          For privacy reasons, do not use your full name or email address within
          nickname.
        </p>
